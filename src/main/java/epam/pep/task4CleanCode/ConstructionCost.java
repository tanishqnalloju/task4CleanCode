...
public class ConstructionCost {
	static double CalculateCost(String materials, double totalAreaOfHouse, String FullyAutomatedHouseChoice) {
		if(FullyAutomatedHouseChoice.equalsIgnoreCase("Yes")) {
		...
		else if (FullyAutomatedHouseChoice.equalsIgnoreCase("No")){
